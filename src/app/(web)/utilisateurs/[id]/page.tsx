...
const UserDetails = (props: { params: { id: string } }) => {
  ...
  if (error || errorGettingUserdata) throw new Error("Données non récupérées");
  ...
  if (!userData) throw new Error("Données non récupérées");

  return (
    <div className="container mx-auto px-2 md:px-4 py-10">
      <div className="grid md:grid-cols-12 gap-10">
        <div className="hidden md:block md:col-span-4 lg:col-span-3 shadow-lg h-fit sticky top-10 bg-[#eff0f2] text-black rounded-lg px-6 py-4">
          <div className="md:w-[143px] w-38 h-38 md:h-[143px] mx-auto mb-5 rounded-full overflow-hidden">
            <Image
              src={userData.image}
              alt={userData.name}
              width={143}
          ...
          <div className="flex items-center">
            <p className="mr-2">Déconnexion</p>
            <FaSignOutAlt
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          <p className="text-xs py-2 font-medium">
            Inscrit depuis {userData._createdAt.split("T")[0]}
          </p>
